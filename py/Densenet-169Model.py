...
# Load the pre-trained DenseNet169 model and modify the final layer to match the number of classes
model = models.densenet169(pretrained=True)
num_ftrs = model.classifier.in_features
model.classifier = nn.Linear(num_ftrs, len(full_dataset.classes))
